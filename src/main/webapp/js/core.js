...
const FacturaExpress = {
    ...
    accessibility: {
        ...
        updateControlStyles() {
            ...
            if (highCtrl) {
                highCtrl.style.background = prefs.altoContraste ? '#1abc9c' : 'rgba(26,188,156,0.1)';
                highCtrl.style.color = prefs.altoContraste ? 'white' : '#1abc9c';
            }
    ...
    CalculationUtils: {
        calculateDailySalesData: function(facturas, dias) {
            ...
            for (let i = dias - 1; i >= 0; i--) {
                ...
                const diasSemana = ['Dom', 'Lun', 'Mar', 'Mi&eacute;', 'Jue', 'Vie', 'S&aacute;b'];
                data.push({
